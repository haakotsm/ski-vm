    ...
    <div class="card col-8 ml-auto mr-auto px-0 pb-2">
        <div class="card-block">
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" name="fornavn" type="text" value="Ola Nordmann" id="fornavn" onchange="nameValidation()">
                </div>
            </div>
            <div class="form-group row">
                <label for="etternavn" class="col-2 col-form-label">Etternavn</label>
                <div class="col-10">
                    <input class="form-control" type="text" name="etternavn" value="Artisanal kale" id="etternavn" onchange="lastnameValidation()">
                </div>
            </div>
            <div class="form-group row">
                <label for="telefon" class="col-2 col-form-label">Telefon</label>
                <div class="col-10">
                    <input class="form-control" name="telefon" type="tel" value="xx xx xx xx" id="telefon" onchange="phoneValidation()">
                </div>
            </div>
            <div class="form-group row">
                <label for="adresse" class="col-2 col-form-label">Adresse</label>
                <div class="col-10">
                    <input class="form-control" name="adresse" type="text" value="oslo veien, 3c" id="adresse" onchange="adresseValidation()">
                </div>
            </div>
            <div class="form-inline row">
                <label class="col-2 justify-content-start">Post</label>
                <div id="post" class="col-10">
                    <input class="form-control" name="poststed" type="text" value="OSLO" id="poststed" onchange="postValidation()">
